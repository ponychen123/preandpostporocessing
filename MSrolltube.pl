#!perl
#20190716 add surpport for system not rightly alined to Cartesian coordination of MS
...
my $axis = "Z";   #for the sake of simplify, only support roll along X axis or Y axis
my $inifile = "20-1";  #you file containg film to roll
